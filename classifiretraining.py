...
try:
  import shutil
   ...
   install('shutil')
import shutil
if (not os.path.exists('data/PublicTest')) or (not os.path.exists('data/Training')):
    if(os.path.exists('data/PublicTest')):
        shutil.rmtree('data/PublicTest')
    if(os.path.exists('data/Training')):
        shutil.rmtree('data/Training')
    from gen_record import generateImages
    generateImages()
...
validation_data_dir = 'data/PublicTest'
